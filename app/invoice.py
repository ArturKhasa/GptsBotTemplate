...
async def generate_invoice(company_info, chat_id):
    ...
    <body>
        ...
        <table border='1' cellpadding='5' cellspacing='0'>
            ...
            <tr><td>1</td><td>Услуги по предоставлению консультации, "Бухгалтер GPT"</td><td>1</td><td>ед</td><td>4 900,00</td><td>4 900,00</td></tr>
        </table>
        <h3>Итого: 4 900,00 руб.</h3>
        <p><b>Без налога (НДС):</b> -</p>
        <h3>Всего к оплате: 4 900,00 руб.</h3>
        <p><b>Всего наименований:</b> 1, на сумму 4 900,00 руб.</p>
